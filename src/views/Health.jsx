export default function Health({daysSF}){
  const ms=[
    ...
    {d:2, t:'Dopo 48 ore', x:'Le terminazioni nervose danneggiate dal fumo iniziano a ripararsi. Migliora la funzione sensoriale: l\'olfatto e il gusto, prima alterati, diventano più acuti. La nicotina è quasi completamente eliminata dal corpo.'},
    ...
    {d:14, t:'2-12 settimane', x:'La circolazione sanguigna migliora. I polmoni funzionano meglio. Attività fisiche come camminare o correre diventano meno faticose, perché cuore e muscoli ricevono più ossigeno.'},
  ...
  return (
    <div className="space-y-3">
      <div className="card p-4 text-sm text-center text-gray-700">
        <p>Nota: i progressi di salute sono basati sui giorni consecutivi senza fumare. Per incentivare i giorni a 0 sigarette, qui anche una sola sigaretta azzera i progressi, MA*</p>
      </div>
      {ms.map((m,i)=>{ const p=perc(m.d); return (
        ...
        <p>*Una singola sigaretta non azzera davvero i benefici accumulati, però provoca danni acuti transitori. Uno “scivolone” estemporaneo non riporta il rischio a quello del fumatore attivo, ma fa male nell’immediato e soprattutto aumenta il rischio di ricaduta. La strategia migliore è considerarla un episodio isolato e tornare subito all’astensione completa.</p>
        </div>
    </div>
  )
}
